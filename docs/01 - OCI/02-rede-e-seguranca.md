...
![Painel inicial](/docs/assets/images/image1.png)


Após isso clique em criar VCN.

![Virtual Cloud Network](/docs/assets/images/image2.png)


Enfim, no painel de configuração da VCN, deixe conforme neste exemplo.

![Configuração de VCN](/docs/assets/images/image3.png)
...
![Configuração da sub-rede pública 1](/docs/assets/images/image4.png)
![Configuração da sub-rede pública 2](/docs/assets/images/image5.png)
...
![Configuração de gateway para internet](/docs/assets/images/image7.png)
![Configuração de gateway NAT](/docs/assets/images/image8.png)
...
![Painel para NSG](/docs/assets/images/image9.png)
![Criação de NSG](/docs/assets/images/image10.png)
...
---
![Configuração de tabela de roteamento](/docs/assets/images/image53.png)

![Configuração de tabela de roteamento](/docs/assets/images/image54.png)
---
...
![Acesso aos componentes de segurança](/docs/assets/images/image11.png)
![Acesso aos componentes de segurança 2](/docs/assets/images/image12.png)
![Acesso aos componentes de segurança 3](/docs/assets/images/image13.png)
...
![Verificação da tabela de roteamento](/docs/assets/images/image24.png)
