---
title: "03 – Configuração do Ambari pela interface"
weight: 50
---
...
![Login no Ambari](/docs/assets/images/image29.png)
...
![Iniciando no Ambari](/docs/assets/images/image30.png)
...
![Nome do cluster](/docs/assets/images/image30.png)
...
3. **No campo de Upload (Add version):**
   - Faça upload do arquivo ODP-VDF.xml (ODP-1.2.2.0-128). Utilize o artefato disponível em [ODP-VDF.xml](/docs/assets/odp-vdf/ODP-VDF.xml).
...
![Versão do ODP personalizado](/docs/assets/images/image32.png)
...
![Opções de instalação](/docs/assets/images/image33.png)
...
![Confirmação de hosts no Ambari](/docs/assets/images/image34.png)
...
- Os demais componentes (ex.: Hive, Ambari Infra Solr, Ranger, Kafka, HBase, NiFi, Spark3, etc.) deverão ser adicionados após a conclusão do setup inicial, um por vez, seguindo a ordem recomendada no documento [Componentes disponíveis](../03.0-configuracao-servicos-componentes/). As configurações específicas de cada um serão tratadas em [Pós-instalação](../04-instalacao-interface/).
...
- [Componentes disponíveis na instalação](../03.0-configuracao-servicos-componentes/)
...
![Divisão de Masters](/docs/assets/images/change2.png)
...
![Seleção de Componentes](/docs/assets/images/change3.png)
...
- Garanta que as portas e firewall estão liberadas conforme [Pré-requisitos](../00-pr%C3%A9requisitos/) e que o SELinux está em modo permissivo durante a instalação inicial.

Observações importantes
- As credenciais e configurações de serviços adicionais como Hive, Ambari Infra Solr, Ranger, Kafka, HBase, NiFi e Spark3 serão definidas quando esses serviços forem instalados, um por vez, seguindo a ordem recomendada em [Componentes disponíveis](../03.0-configuracao-servicos-componentes/) e com detalhes práticos em [Pós-instalação](../04-instalacao-interface/).
...
- [Pós-instalação: instalação e configuração dos serviços](../04-instalacao-interface/)
...
![Atribuição de senhas](/docs/assets/images/image50.png)
...
![Forma final da etapa](/docs/assets/images/change4.png)
