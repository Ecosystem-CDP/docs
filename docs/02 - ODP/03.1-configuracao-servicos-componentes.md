...
1. Tez
   - Motivo: provê engine DAG sobre YARN e otimiza consultas do Hive.
2. Hive (Metastore + HiveServer2 + Cliente)
...
4. Ranger (Admin + Usersync + Tagsync)
